...
class _BoxIdRecognitionScreenState extends State<BoxIdRecognitionScreen> {
  ...
  Future<void> _takePhoto() async {
    ...
    try {
      ...
      if (photo != null) {
        ...
        if (id != null) {
          ...
          try {
            ...
            _logService.error('Erro ao buscar caixa', error: e, category: 'box_recognition');
            setState(() {
      ...
      _logService.error('Erro ao capturar ou processar a imagem', error: e, category: 'box_recognition');
      setState(() {
